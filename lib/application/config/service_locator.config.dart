...
import '../logger/i_mylogger.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i6.IUserRepository>(() => _i7.UserRepository(
      connection: get<_i3.IDatabaseConnection>(), log: get<_i8.IMyLogger>()));
  gh.lazySingleton<_i9.IUserService>(() => _i10.UserService(
      userRepository: get<_i6.IUserRepository>(), log: get<_i8.IMyLogger>()));
  gh.factory<_i11.AuthController>(() => _i11.AuthController(
      userService: get<_i9.IUserService>(), log: get<_i8.IMyLogger>()));
  return get;
}
